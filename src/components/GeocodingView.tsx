    ...
    <div className="p-4 md:p-6 space-y-4 max-w-5xl mx-auto">
      ...
      <Tabs defaultValue="forward" className="w-full">
        ...
        <TabsContent value="forward" className="space-y-3">
          <Card>
            <CardHeader>
              <CardTitle className="">Batch address geocoding</CardTitle>
              <CardDescription>
        ...
        <TabsContent value="reverse" className="space-y-3">
          <Card>
            <CardHeader>
              <CardTitle className="">Reverse geocoding</CardTitle>
        ...
        <TabsContent value="ip" className="space-y-3">
          <Card>
            <CardHeader>
              <CardTitle className="">IP address geolocation</CardTitle>
