  ...
  return (
    <Card className="border-0 shadow-card">
      ...
      <CardHeader className="flex flex-row items-start justify-between gap-4 flex-wrap">
        <div>
          <CardTitle>Supervisory Gap Analysis Map</CardTitle>
          <CardDescription>
      ...
      <CardContent className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <Card>
              <CardHeader className="pb-2">
                <CardTitle>Gap Severity Summary</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            {/* Gap by Domain */}
            <Card>
              <CardHeader className="pb-2"><CardTitle>Gap by Domain</CardTitle></CardHeader>
              <CardContent>
            ...
            {/* Top 5 LGAs */}
            <Card>
              <CardHeader className="pb-2"><CardTitle>Top 5 LGAs by Critical Gaps</CardTitle></CardHeader>
              <CardContent>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
          <Card>
            <CardHeader className="pb-2"><CardTitle>Gap Insights</CardTitle></CardHeader>
            <CardContent className="text-xs text-muted-foreground leading-relaxed">{insights}</CardContent>
          </Card>
          <Card>
            <CardHeader className="pb-2"><CardTitle>Recommended Actions</CardTitle></CardHeader>
          ...
          <Card>
            <CardHeader className="pb-2"><CardTitle>Supervisory Progress</CardTitle></CardHeader>
            <CardContent>
        ...
        <Card className="mt-5 border-amber-300/70 bg-gradient-to-br from-amber-50/80 to-transparent dark:border-amber-800/60 dark:from-amber-950/20">
          <CardHeader className="flex flex-row items-start justify-between gap-3 pb-2">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <CardTitle>Off-Microplan Communities</CardTitle>
