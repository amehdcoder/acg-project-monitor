...
const rows = [
  { id: "1", state: "Kano", lga: "Dala", ward: "Kabuwaya", flhf_name: "PHC A", community_name: "C1", estimated_total_population: 100, created_at: "2026-01-01" },
  // exact duplicate (removable) — must not change ward counts
  { id: "2", state: "kano ", lga: "Dala", ward: " kabuwaya", flhf_name: "PHC A", community_name: "C1", estimated_total_population: 100, created_at: "2026-01-02" },
  // same ward name, different LGA → distinct ward
  { id: "3", state: "Kano", lga: "Gwale", ward: "Kabuwaya", flhf_name: "PHC B", community_name: "C2", estimated_total_population: 50, created_at: "2026-01-01" },
  // blanks / placeholders must not count
  { id: "4", state: "Kano", lga: "", ward: "  ", flhf_name: "Unassigned Health Facility", community_name: "C3", estimated_total_population: 10, created_at: "2026-01-01" },
];
