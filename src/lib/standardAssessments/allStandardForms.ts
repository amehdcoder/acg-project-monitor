...
const EXTRA_STANDARD_FORMS: StandardFormOption[] = [
  ...
  { code: "irf_form", name: "SARMAAN ACSM Indicator Reporting Form (SAIRF)", group: "Project Tools" },
  { code: "irf_dash", name: "SARMAAN ACSM Indicator Tracking Dashboard", group: "Project Tools" },
];
