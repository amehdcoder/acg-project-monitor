...
const translations: Record<Language, TranslationKeys> = {
  ...
  id: {
    "nav.dashboard": "Ọ́gba Ọ́nọ́",
    "nav.supervisor": "Ọ́ga Ọ́nọ́",
    "nav.forms": "Ípù",
    "nav.cases": "Ọ̀ràn",
    "nav.templates": "Ápù Ípù",
    "nav.projects": "Ọ́lá",
    "nav.analytics": "Ẹ́nyọ́ & Ọ̀nà",
    "nav.integrations": "Ịjikọ",
    "nav.users": "Ọ́chẹ Ọ́lá",
    "nav.settings": "Ọ́tù",
    "nav.help": "Ẹ́nyemaka & Ọ̀kpa",
    "nav.main_menu": "Ípù Isi",
    "auth.login": "Bányé",
    "auth.signup": "Dé Áhà",
    "auth.email": "Email",
    "auth.password": "Ọ́kà Ási",
    "auth.confirm_password": "Kwé Ọ́kà Ási",
    "auth.first_name": "Áhà Ọ́kwú",
    "auth.last_name": "Áhà Ẹ́dù",
    "auth.phone": "Nọ́mba Ékwéntị",
    "auth.forgot_password": "Chéfù ọ́kà ási?",
    "auth.create_account": "Mépé Ákáụntụ",
    "auth.welcome_back": "Nnọọ ọ́zọ!",
    "auth.or_continue_with": "ma ọ bụ gá n'iru site na",
    "auth.designation": "Ọ́kwa",
    "auth.state": "Steeti",
    "dashboard.title": "Ọ́gba Ọ́nọ́",
    "dashboard.total_forms": "Ípù Niile",
    "dashboard.submissions": "Íhé É Zígárá",
    "dashboard.pending_sync": "Ná-éché Ịjikọ",
    "dashboard.sync_rate": "Ọ́nụọgụ Ịjikọ",
    "dashboard.field_activity": "Ọ́lá Ụ́bì",
    "dashboard.recent_forms": "Ípù Ọ́hụrụ",
    "dashboard.fill_form": "Jụpụta Ípù Ọ́hụrụ",
    "dashboard.sync_data": "Jikọta Ẹ́nyọ́",
    "supervisor.title": "Ọ́gba Ọ́ga",
    "supervisor.subtitle": "Nlékọta ógé nkịtị nké ọ́lá ndị ná-ánákọta ẹ́nyọ́",
    "supervisor.active_now": "Ná-árụ Ọ́lá Ugbu a",
    "supervisor.total_enumerators": "Ndị Ọ́lá Niile",
    "supervisor.submissions_today": "Nké Tàá",
    "supervisor.geofence_compliance": "Ndàbéré Ókè Álà",
    "supervisor.active_alerts": "Ịdọ Ákà Ná Ntị",
    "supervisor.enumerator_status": "Ọ́nọdụ Ndị Ọ́lá",
    "supervisor.top_performers": "Ndị Káchasị Mmá",
    "supervisor.needs_attention": "Chọrọ Nlébárá Anyá",
    "supervisor.refresh": "Mée Ọ́hụrụ",
    "supervisor.all_clear": "Íhé Niile Dị Mmá",
    "common.loading": "Ná-ébú...",
    "common.save": "Chékwáá",
    "common.cancel": "Kágbúọ",
    "common.delete": "Hịchápụ",
    "common.edit": "Dézíé",
    "common.search": "Chọọ",
    "common.filter": "Nyọchá",
    "common.export": "Búpụta",
    "common.refresh": "Mée Ọ́hụrụ",
    "common.back": "Lágháchí",
    "common.submit": "Nyéfée",
    "common.no_data": "Ẹ́nwéghị ẹ́nyọ́",
    "common.active": "Ná-árụ ọ́lá",
    "common.idle": "Ná-ézùíké",
    "common.offline": "Ẹ́nwéghị njikọ",
    "common.today": "Tàá",
    "common.sign_out": "Pụọ",
    "common.profile": "Profaịlụ",
    "common.all": "Niile",
    "quality.title": "Ịdị Mmá Ẹ́nyọ́ AI",
    "quality.duplicates": "Ndị Ọ́kpụrụkpụ",
    "quality.anomalies": "Íhé Pụrụ Íché",
    "quality.validations": "Nyọchá",
    "quality.analyzing": "AI ná-ényọchá ẹ́nyọ́ gị...",
    "quality.no_analysis": "A nábéghị nyọchá ọ bụlá",
    "quality.score": "Ákárá Ịdị Mmá",
    "quality.recommendation": "Ndụmọdụ",
    "quality.findings": "Íhé Á Chọpụtárá",
    "quality.no_issues": "Áhụghị nsógbú ọ bụlá",
    "reports.title": "Ákụkọ",
    "reports.generate": "Mépụtá Ákụkọ",
    "reports.schedule": "Házíé Ákụkọ",
    "reports.daily_summary": "Nchịkọtá Ụbọchị",
    "reports.weekly_report": "Ákụkọ Ízù",
    "reports.export_pdf": "Búpụtá PDF",
    "reports.export_excel": "Búpụtá Excel",
  },
};
