...
const translations: Record<Language, TranslationKeys> = {
  ...
  id: {
    "nav.dashboard": "Ola Eyi",
    "nav.supervisor": "Oga Ola",
    "nav.forms": "Takada",
    "nav.cases": "Okwu",
    ...
    "auth.signup": "Kla Ehi",
    "auth.email": "Email",
    "auth.password": "Okla Ehi",
    "auth.confirm_password": "Gba Okla Ehi",
    "auth.first_name": "Ehi Otule",
    "auth.last_name": "Ehi Olaye",
    "auth.phone": "Namba Eko-igbo",
    "auth.forgot_password": "Uche okla ehi odu?",
    "auth.create_account": "Kpo Ehi Ofu",
    "auth.welcome_back": "Ahinya o'wa!",
    "auth.or_continue_with": "amla gbe gba",
    "auth.designation": "Okla",
    "auth.state": "Ipule",
    "dashboard.title": "Ola Eyi",
    ...
    "supervisor.geofence_compliance": "Ogba Okpla",
    ...
    "supervisor.all_clear": "Olilae Nma",
    "common.loading": "Le obu...",
    "common.save": "Gba",
    "common.cancel": "Kpo Odu",
    "common.delete": "Kpo Okla",
    "common.edit": "Leche",
    "common.search": "Che",
    "common.filter": "Laye",
