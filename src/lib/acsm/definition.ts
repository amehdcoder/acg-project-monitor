  ...
  results_of_advocacy: [
    {
      ...
      level: "outcome",
      levels: ["outcome", "impact"],
      unit: "number_of_people",
      wording: "number of people who benefited from the advocacy efforts",
      purpose:
        "Measures the total number of individuals who directly benefited from the results of the advocacy strategy (e.g. improved policies, services or resources resulting from the advocacy).",
      definition: [
        "Define what counts as 'benefiting' from the advocacy results in your context.",
        "Identify the population affected by the adopted policy / decision / resource change.",
        "Count the number of people benefiting, avoiding double counting, using routine records and review of relevant resources.",
      ],
      disaggregations: ["gender", "age_group"],
      importantComments: [
        "Supplement the value with qualitative information on how people benefited and the strength of the link to the advocacy work.",
      ],
      frequency: "Annually",
    ...
    },
    {
      ...
      wording: "number of advocacy recommendations formally adopted by decision-makers",
      purpose:
        "Tracks the uptake of advocacy asks into policies, plans, budgets or formal commitments by the targeted decision-makers.",
      definition: [
        "Define what counts as a 'recommendation' and what counts as 'adopted' (e.g. reflected in an approved policy, plan or budget).",
        "Review official documents and conduct key informant interviews to verify adoption.",
        "Count only formally adopted recommendations attributable to the advocacy work.",
      ],
      disaggregations: [],
      importantComments: [
        "Exclude verbal commitments without documentation and recommendations still under review.",
      ],
      frequency: "Quarterly",
      guidancePending: true,
    },
    {
      ...
      purpose:
        "Measures the financial resources allocated by governments or institutions in approved budgets following advocacy.",
      definition: [
        "Identify approved budget lines / appropriations attributable to the advocacy efforts.",
        "Review approved budget documents to confirm the committed amounts.",
        "Sum the committed amounts to determine the indicator's value.",
      ],
      disaggregations: [],
      importantComments: [
        "Budgetary commitment (appropriated) differs from disbursement (released) — track them separately.",
      ],
      frequency: "Quarterly",
      guidancePending: true,
    },
    {
      ...
      purpose:
        "Tracks whether budgetary commitments translate into released funds for implementation.",
      definition: [
        "Identify the funds released against the committed budget.",
        "Verify disbursement using official financial / disbursement records.",
        "Sum the disbursed amounts to determine the indicator's value.",
      ],
      disaggregations: [],
      importantComments: [
        "Report disbursement alongside the original commitment to show the release rate.",
      ],
      frequency: "Quarterly",
      guidancePending: true,
    },
