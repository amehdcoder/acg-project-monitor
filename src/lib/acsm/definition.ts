  ...
  capacities_for_advocacy: [
    {
      ...
      levels: ["output", "outcome"],
      unit: "percentage",
      wording: "% of [target group] who understand the key principles and practices of effective advocacy",
      purpose:
        "Assesses to what extent target group members (e.g. advocacy team members or partner-organisation staff) understand the key principles and practices of designing and implementing effective advocacy initiatives. It indicates their ability to support effective advocacy and highlights needs for further training.",
      definition: [
        "Define who is expected to understand the key principles and practices of effective advocacy — primarily people who design or implement the advocacy initiatives, including partner-organisation staff.",
        "Define the essential amount of the most important knowledge these people should have.",
        "Prepare a simple, practical test (knowledge questions, scenarios with no predefined answers, choice between correct/incorrect statements, and questions probing common misconceptions). Include enough open-ended questions, engage an expert if needed, and pre-test the difficulty.",
        "Decide how many marks each correct answer is worth (e.g. simple questions 1 mark, complex questions / scenarios 2 marks).",
        "Decide the minimum marks a person needs to be considered as understanding effective advocacy (e.g. at least 15 out of 20).",
        "Administer the test. To compare understanding before and after a learning event, design two comparable tests for a pre- and post-test.",
        "Count the number of people who achieved the minimum acceptable score.",
        "Calculate the value: divide the number who achieved the minimum score by the total who completed the test, then multiply by 100 to get a percentage.",
      ],
      disaggregations: ["seniority", "gender", "age_group"],
      importantComments: [
        "This is not meant to be a heavy exercise — define what people really need to know, prepare a practical test of it, and use the results.",
        "Share the test results with participants as a learning opportunity, accompanied by a discussion of the correct answers.",
      ],
    ...
    },
    {
      ...
      levels: ["process"],
      unit: "number_of_documents",
      wording: "the frequency of reviews and revisions of the advocacy plan",
      purpose:
        "Shows the extent to which an advocacy team uses their agreed advocacy plan as a living, breathing document that is reviewed, reflected upon, and revised when necessary. Advocacy is dynamic, so the plan must appropriately guide and support those working towards the shared goal.",
      definition: [
        "Establish the extent to which the advocacy team has used the plan as a 'living document' updated whenever important information required a change — looking primarily at what changes were made over time and how often.",
        "Gather this by reviewing relevant documents (records of advocacy meetings, descriptions of changes to the plan and their rationale, and the different plan versions for comparison) and by interviewing advocacy team members.",
        "To report, explain how often and how the plan was reviewed and revised.",
      ],
      disaggregations: [],
      importantComments: [
        "Revisions reflect that action and learning are happening — information from the outside world is being processed to inform the next steps on the advocacy journey.",
        "This indicator complements the 'Advocacy Sharing and Learning Sessions' indicator.",
      ],
      frequency: "Quarterly",
    },
    {
      ...
      levels: ["output", "outcome"],
      unit: "percentage",
      wording: "% of [target group] who have used the provided knowledge / skills",
      purpose:
        "Measures the extent to which participants put into practice knowledge or skills acquired through project-supported activities (trainings, workshops, demonstrations). It focuses on the actual application of new competencies in relevant contexts.",
      definition: [
        "Define a limited number of the most important knowledge / skills the project wants participants to use, relevant to what they can realistically apply in their context.",
        "Decide how you will measure use: structured interviews with a representative sample (with probing and verification of how/when skills were used); direct observation or review of written records; or reports from supervisors, peers or community members.",
        "Consider setting a minimum standard for when a participant is considered to have 'used' the knowledge / skills (minimum number of areas used, minimum frequency, or evidence of correct application). Keep standards measurable and realistic.",
        "Collect the required data at an appropriate time after the activity — be realistic about when people could use what they learned.",
        "Determine the value: count participants who meet the minimum standard of use, divide by the total surveyed, and multiply by 100 to get a percentage.",
      ],
      disaggregations: ["gender", "age_group"],
      importantComments: [
        "Where possible, measure use both before and after the activity so changes can be attributed to the project.",
        "Decide whether to measure use from a single activity or the cumulative effect of multiple activities.",
        "Be careful about timing — collecting data before people had the need/opportunity to use the skills will be misleading.",
        "Assess actual use (not just intention); use prompts and triangulation to reduce desirability bias.",
        "If possible, repeat the assessment (soon after, and again months later) to measure sustained use.",
        "Where relevant, ask how and why participants used or did not use the knowledge / skills to understand enablers and barriers.",
      ],
      frequency: "Quarterly",
    },
    {
      ...
      levels: ["output", "outcome"],
      unit: "percentage",
      wording: "number / % of [target group] with the desired media skills and contacts",
      purpose:
        "Measures the proportion of members of a specific target group (e.g. campaign spokespeople or grassroots organisation members) who have the desired media skills and contacts — a crucial part of many advocacy efforts.",
      definition: [
        "Define who the target group members are — primarily people implementing advocacy initiatives who must have the desired media skills and contacts.",
        "Define a limited number of the most important media skills and contacts they should have.",
        "Prepare a practical test (written knowledge test, practical tasks such as writing a press release or managing social media, and role plays). Pre-test the difficulty among several people.",
        "Decide the minimum result a person needs to pass (e.g. 7 of 10 knowledge questions and 3 of 5 tested skills correct).",
        "Administer the test to a representative sample of the target group.",
        "Calculate the value: divide the number with the minimum required knowledge / skills by the total tested, then multiply by 100 to get a percentage.",
      ],
      disaggregations: ["gender", "age_group"],
      importantComments: [
        "Complement the value with qualitative information on the types of media skills and contacts gained.",
        "Media skills are a longer-term learning process — consider a light-touch Media Training Plan setting who/when/where/how/by whom and on which topics.",
        "Consider a pre-test and post-test to understand improvement.",
        "To assess application, consider measuring media engagements initiated and media coverage achieved following the training.",
      ],
      frequency: "Per activity",
    },
    {
      ...
      wording: "the number of sharing and learning sessions on the advocated issue facilitated in [time period]",
      purpose:
        "Measures the number of sessions where people working on the same or related advocacy efforts had an opportunity to share experiences and learn from others — valuable for improving advocacy capacities, creating shared purpose, building peer support and gaining inspiration.",
      definition: [
        "Define what can be considered a 'sharing and learning session' — an occasion where people from different advocacy teams meet, share experiences (lessons learned, good practices) and learn from each other.",
        "Use key informant interviews and review of relevant documents to count the number of sharing and learning sessions, as defined.",
      ],
      disaggregations: [],
      importantComments: [
        "In addition to the number of sessions, provide qualitative information on participants, topics discussed, and learning outcomes or other benefits.",
        "Sessions are also opportunities to gather information on training needs and to identify and celebrate individual and collective successes.",
      ],
      frequency: "Monthly",
    },
    {
      ...
      levels: ["output"],
      unit: "number_of_events",
      wording: "increased representation in fora relevant to the advocacy objectives",
      purpose:
        "Measures the extent to which advocacy team members are actively represented in local, national or international fora relevant to the advocacy objectives — essential for building the influence needed to achieve the desired changes.",
      definition: [
        "Define the fora most relevant to your advocacy efforts — a limited number of platforms attended by people who can contribute to the advocacy objectives (e.g. government officials).",
        "Use interviews with advocacy team members to understand the extent of their involvement: how many fora they participate in, how actively / with what influence, and how influential those fora are relative to other relevant fora.",
        "To report, describe how representation in the relevant fora changed during the reporting period (presumably how it increased).",
      ],
      disaggregations: [],
      importantComments: [
        "Advocacy is collaborative and time-intensive — the advocacy plan should decide in which fora to engage, why, with what level of resources, and to what end.",
      ],
      frequency: "Quarterly",
    },
  ],
