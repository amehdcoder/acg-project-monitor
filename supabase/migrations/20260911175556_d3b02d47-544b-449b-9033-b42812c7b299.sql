...
DECLARE
  ...
  v_designation public.user_designation := 'data_collector';
  v_avatar TEXT;
BEGIN
  IF EXISTS (
  ...
  -- Owner addresses live in the private owner_emails registry (service-role only),
  -- so no personal address is embedded in this trigger.
